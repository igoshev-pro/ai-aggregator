  ...
  private buildModelsCatalog(): any[] {
    return [
      ...
      },
      {
        ...
        description: 'Балансированная модель Anthropic нового поколения (Sonnet 5)',
        type: 'text',
        pricePerMillionInputTokens: 162,
        pricePerMillionOutputTokens: 810,
        providerCostPerMillionInput: 1.8,
        providerCostPerMillionOutput: 9.0,
        avgTokensPerRequest: 1500,
        tokensPerDollar: 90,
        minTokenCost: 0.6,
        sortOrder: 4.5,
        ...
        capabilities: ['streaming', 'vision', 'thinking'],
        providerMappings: [
          { providerSlug: 'evolink', modelId: 'claude-sonnet-5', priority: 1, isActive: true },
        ],
        defaultParams: { maxTokens: 8192, temperature: 0.7 },
        limits: { maxInputTokens: 200000, maxOutputTokens: 8192, includedInPlans: ['pro', 'unlimited'] },
      },
      ...
      },
      {
        ...
        description: 'Новейшая мультимодальная reasoning-модель от xAI (управляемое мышление, web search)',
        type: 'text',
        pricePerMillionInputTokens: 72,
        pricePerMillionOutputTokens: 216,
        providerCostPerMillionInput: 0.8,
        providerCostPerMillionOutput: 2.4,
        avgTokensPerRequest: 1500,
        tokensPerDollar: 90,
        minTokenCost: 1.2,
        sortOrder: 14.5,
        isPremium: true,
        supportsVision: true,
        capabilities: ['streaming', 'reasoning', 'vision', 'web_search'],
        providerMappings: [
          { providerSlug: 'kie', modelId: 'grok-4-5', priority: 1, isActive: true },
        ],
        defaultParams: { maxTokens: 8192, temperature: 0.7 },
        limits: { maxInputTokens: 256000, maxOutputTokens: 8192, includedInPlans: ['pro', 'unlimited'] },
      },
      ...
      },
      {
        ...
        capabilities: ['text_to_image', 'image_to_image'],
        providerMappings: [
          { providerSlug: 'kie', modelId: 'nano-banana-2-lite', priority: 1, isActive: true },
        ],
        defaultParams: { aspect_ratio: 'auto' },
        ...
        uiParameters: [
          {
            key: 'aspectRatio', label: 'Соотношение сторон', type: 'select', affectsPrice: false, defaultValue: 'auto',
            options: [
