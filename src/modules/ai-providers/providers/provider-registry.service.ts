  ...
  private buildModelsCatalog(): any[] {
    return [
            ...
            // ─── GPT 5.6 (KIE /codex/v1/responses) ──────────────
      {
        ...
        description: 'Новейшая мультимодальная модель OpenAI (Luna) с управляемым мышлением',
        type: 'text',
        pricePerMillionInputTokens: 202.5,
        pricePerMillionOutputTokens: 1215,
        providerCostPerMillionInput: 2.25,
      ...
      },
      {
        ...
        description: 'Мультимодальная модель OpenAI (Terra) с управляемым мышлением',
        type: 'text',
        pricePerMillionInputTokens: 202.5,
        pricePerMillionOutputTokens: 1215,
        providerCostPerMillionInput: 2.25,
      ...
      },
      {
        ...
        description: 'Мультимодальная модель OpenAI (Sol) с управляемым мышлением',
        type: 'text',
        pricePerMillionInputTokens: 202.5,
        pricePerMillionOutputTokens: 1215,
        providerCostPerMillionInput: 2.25,
