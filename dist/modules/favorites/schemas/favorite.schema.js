...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], Favorite.prototype, "itemId", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Favorite.prototype, "previewUrl", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Object, default: {} }),
    __metadata("design:type", Object)
], Favorite.prototype, "metadata", void 0);
exports.Favorite = Favorite = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Favorite);
exports.FavoriteSchema = mongoose_1.SchemaFactory.createForClass(Favorite);
exports.FavoriteSchema.index({ userId: 1, type: 1, itemId: 1 }, { unique: true });
