...
], Referral.prototype, "bonusEarned", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: false }),
    __metadata("design:type", Boolean)
], Referral.prototype, "hasPurchased", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", Date)
], Referral.prototype, "firstPurchaseAt", void 0);
exports.Referral = Referral = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Referral);
exports.ReferralSchema = mongoose_1.SchemaFactory.createForClass(Referral);
exports.ReferralSchema.index({ referrerId: 1 });
exports.ReferralSchema.index({ referredId: 1 }, { unique: true });
