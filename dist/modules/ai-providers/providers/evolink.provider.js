...
exports.EvolinkProvider = void 0;
const axios_1 = require("axios");
const base_provider_abstract_1 = require("./base-provider.abstract");
class EvolinkProvider extends base_provider_abstract_1.BaseProvider {
    constructor(config) {
    ...
    async generateImage(request) {
        ...
        try {
            ...
            let taskId;
            if (data.images) {
                urls = data.images.map((img) => img.url);
            }
...
exports.EvolinkProvider = EvolinkProvider;
//# sourceMappingURL=evolink.provider.js.map