...
exports.KieProvider = void 0;
const axios_1 = require("axios");
const base_provider_abstract_1 = require("./base-provider.abstract");
class KieProvider extends base_provider_abstract_1.BaseProvider {
    constructor(config) {
        super('kie', config);
...
exports.KieProvider = KieProvider;
//# sourceMappingURL=kie.provider.js.map